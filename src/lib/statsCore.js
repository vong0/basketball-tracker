...
// ── Column definitions (shared between statsCore and view components) ─────────

export const GAME_BOX_SCORE_COLS = [
...
export const PLAYER_GAME_LOG_COLS = [
...
export const STAT_LEADERS_SCORING_COLS = [
  { key: 'player',       label: 'Player', align: 'left' },
...
export const STAT_LEADERS_CREATION_COLS = [
  { key: 'player',              label: 'Player',   align: 'left' },
...
export const STAT_LEADERS_SCREENING_COLS = [
  { key: 'player',               label: 'Player',  align: 'left' },
...
export const STAT_LEADERS_REBDEF_COLS = [
  { key: 'player',      label: 'Player',  align: 'left' },
